def printable_clean_sf_visual(sf):
    ...
    cleaner = sf.get_board_visual().replace('-', '').replace('   ', '.').replace(' ', '').replace('+', '').replace('|', '').replace('a.b.c.d.e.f.g.h', '').replace('8', '').replace('7', '').replace('6', '').replace('5', '').replace('4', '').replace('3', '').replace('2', '').replace('1', '')
